...
C
     ...
     &                         FWEL,FDRN,FSDR,FRCH,FEVT,FRIV,FGHB,FSTR,
     &                         FRES,
...
C--ARE USED IN FLOW MODEL
      IF(IVER.EQ.1) THEN
        READ(INSSM,'(6L2)') FWEL,FDRN,FSDR,FRCH,FEVT,FRIV,FGHB
...
C
     ...
     &                         CNEW,
     &                         FWEL,FDRN,FSDR,FRIV,FGHB,FRCH,FEVT,FSTR,
     &                         FRES,
     &                         FFHB,FIBS,FTLK,FLAK,FMNW,FDRT,FETS,FSWT,
     &                         FSFR,FUZF,
...
C
     ...
     &                         ISS,FWEL,FDRN,FSDR,FRCH,FEVT,FRIV,FGHB,
     &                         FSTR,
