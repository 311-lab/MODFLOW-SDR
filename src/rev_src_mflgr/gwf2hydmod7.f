...
C  inital SE call in the AR subroutine.
      MODULE HYDBASMODULE
        ...
        END TYPE
        TYPE(HYDBASTYPE),   SAVE  :: HYDBASDAT(100)
      END MODULE
      ...
      MODULE HYDIBSMODULE
        ...
        END TYPE 
        TYPE(HYDIBSTYPE),  SAVE  ::HYDIBSDAT(100)
      END MODULE
      ...
      MODULE HYDSUBMODULE
        ...
        END TYPE 
        TYPE(HYDSUBTYPE),  SAVE  ::HYDSUBDAT(100)
      END MODULE
      ...
      MODULE HYDSTRMODULE
        ...
        END TYPE
        TYPE(HYDSTRTYPE),   SAVE   ::HYDSTRDAT(100)
      END MODULE
      ...
      MODULE HYDSFRMODULE
        ...
        END TYPE
        TYPE(HYDSFRTYPE),   SAVE   ::HYDSFRDAT(100)
      END MODULE
